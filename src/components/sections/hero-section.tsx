            ...
            >
              <motion.div className="space-y-4" variants={itemVariants}>
                ...
                <h1 className="text-4xl font-heading font-bold tracking-tighter sm:text-5xl xl:text-7xl/none">
                  <span className="gradient-text">E-BAZAR a Shoping Mall </span>
                  <br />
                  <span className="text-foreground">A Mall at your fingure tip</span>
                </h1>
                <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400 opacity-70">
                A premium and luxury experience at an affordable price — e-BAZAR brings you suitable, sustainable, and handy products, including grocery essentials, lifestyle goods, and everyday solutions, all tailored to your convenience.
                </p>
              </motion.div>
              ...
              <motion.div variants={itemVariants} className="pt-4">
                <p className="text-sm text-muted-foreground flex items-center">
                  ...
                  Trusted by 2,000+ customers worldwide
                </p>
              </motion.div>
            </motion.div>
          </ScrollReveal>
            ...
            <SpotlightCard className="relative h-[450px] w-full overflow-hidden rounded-xl border glassmorphic-card p-1 border-glow-red">
              ...
              <div className="relative z-20 h-full w-full rounded-xl bg-gradient-to-br from-red-950/50 to-gray-950/50 p-6 flex items-center justify-center">
                <div className="grid grid-cols-2 gap-6 w-full max-w-md">
                  ...
                  >
                    <span className="font-heading text-xl text-white tracking-tight">Premium Brands</span>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <span className="font-heading text-white tracking-tight">Grocery</span>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    ...
                    whileHover={{ scale: 1.03, boxShadow: "0 0 15px rgba(220, 38, 38, 0.3)" }}
                  >
                    <span className="font-heading text-white tracking-tight">Medicines</span>
                  </motion.div>
                </div>
              </div>
            </SpotlightCard>
