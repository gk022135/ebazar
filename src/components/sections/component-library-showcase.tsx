          ...
          <div className="mt-8">
            <Tabs defaultValue={activeTab} onValueChange={setActiveTab} className="w-full">
              <div className="flex justify-center mb-12">
                ...
                >
                  <TabsList className="glassmorphic-tabs border-0">
                    <TabsTrigger value="cards">Men's</TabsTrigger>
                    <TabsTrigger value="buttons">Women's</TabsTrigger>
                    <TabsTrigger value="progress">Kid's</TabsTrigger>
                  </TabsList>
                </AnimatedGradientBorder>
              </div>
              ...
              <TabsContent value="cards" className="space-y-12">
                <div className="space-y-4">
                  <h3 className="text-2xl font-medium tracking-tight text-center">Categories</h3>
                  <p className="text-muted-foreground text-center max-w-3xl mx-auto mb-8">
                    Versatile Categories, with perfect showcasing  of style, products, or features
                  </p>
